...
import cr.ac.una.reg.info.bl.ReporteRemisionBean;
...
public class ReporteRemision extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String idestudi = request.getParameter("id").equals("")? null:request.getParameter("id");
            response.setContentType("application/pdf");
            ...
            String rutaRelativaApp = getServletContext().getRealPath("/") + "Reportes\\ReporteRemision.jrxml";

            response.setHeader("Cache-Control", "max-age=30");
            ReporteRemisionBean be = new ReporteRemisionBean();
            byte[] bytes = be.getBytes(rutaRelativaApp,fechaIni,fechaFin,dependen,funciona,idestudi);
